...
with gr.Blocks() as demo:
    ...
    with gr.Tabs():
        with gr.Tab("🔍 文字素材打标"):
            ...
            # 更新图片显示和打标结果的回调逻辑
            check_button.click(lambda file: (file, video_rec.rec(file, 1)), inputs=file_input, outputs=[image_display, check_output])
        ...
        with gr.Tab("🎨 非文字类素材风格打标"):
            ...
            # 更新图片显示和打标结果的回调逻辑
            check_button2.click(lambda file: (file, video_rec.rec(file, 2)), inputs=file_input2, outputs=[image_display2, check_output2])
